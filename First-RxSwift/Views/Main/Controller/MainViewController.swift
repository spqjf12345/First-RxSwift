...
class MainViewController: UIViewController {
    ...
    @IBAction func allVC(_ sender: Any) {
        selectSegmentWith(selectedIndex: 0)
    }

    @IBAction func textVC(_ sender: Any) {
        selectSegmentWith(selectedIndex: 1)
    }

    @IBAction func linkVC(_ sender: Any) {
        selectSegmentWith(selectedIndex: 2)
    }

    @IBAction func giftVC(_ sender: Any) {
        selectSegmentWith(selectedIndex: 3)
    }

    @IBAction func calendarVC(_ sender: Any) {
        selectSegmentWith(selectedIndex: 4)
    }
    ...
    private func layout() {
        ...
        pageViewController.view.snp.makeConstraints { make in
            ...
            make.top.equalTo(self.tapStackView.snp_bottomMargin).offset(10)
